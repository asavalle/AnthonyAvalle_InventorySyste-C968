    ...
    static class Inventory
    {
        ...
        *************************/
        static Inventory()
        {
            ...
            AllParts.Add(new Outsourced { Name = "left pedal", Price = (decimal)10.00, InStock = 10, Min = 5, Max = 20, CompanyName = "Company1", Outsorced = true });
            AllParts.Add(new Outsourced { Name = "right pedal", Price = (decimal)5.00, InStock = 10, Min = 10, Max = 40, CompanyName = "Company1", Outsorced = true });
            AllParts.Add(new Outsourced { Name = "boy's frame", Price = (decimal)25.00, InStock = 10, Min = 10, Max = 40, CompanyName = "Company2", Outsorced = true });
            AllParts.Add(new Outsourced { Name = "girls frame", Price = (decimal)25.00, InStock = 10, Min = 5, Max = 20, CompanyName = "Company3", Outsorced = true });
